...
docker tag nodeshift/centos7-s2i-web-app:11.x 172.30.1.1:5000/nodeshift/centos7-s2i-web-app:11.x

# Pushes the image to the openshift docker registry.
docker push 172.30.1.1:5000/nodeshift/centos7-s2i-web-app:11.x

# Creates a new app based on the pushed image.
oc new-app 172.30.1.1:5000/nodeshift/centos7-s2i-web-app:11.x~https://github.com/lholmquist/react-web-app
