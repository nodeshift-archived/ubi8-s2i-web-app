...
docker tag nodeshift/ubi8-s2i-web-app:latest 172.30.1.1:5000/nodeshift/ubi8-s2i-web-app:latest

# Pushes the image to the openshift docker registry.
docker push 172.30.1.1:5000/nodeshift/ubi8-s2i-web-app:latest

# Creates a new app based on the pushed image.
oc new-app 172.30.1.1:5000/nodeshift/ubi8-s2i-web-app:latest~https://github.com/lholmquist/react-web-app
